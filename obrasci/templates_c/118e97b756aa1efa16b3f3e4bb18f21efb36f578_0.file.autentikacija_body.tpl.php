<?php
/* Smarty version 4.3.0, created on 2023-05-22 15:47:49
  from 'C:\xampp\htdocs\projekt\templates\autentikacija_body.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
  'version' => '4.3.0',
  'unifunc' => 'content_646b72857f7b23_80749064',
  ...
  function content_646b72857f7b23_80749064(Smarty_Internal_Template $_smarty_tpl)
  {
    echo '<script'; ?>
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['imeprezimeprovjera']->value)) && strlen($_smarty_tpl->tpl_vars['imeprezimeprovjera']->value) > 2) { ?>
                  <label style="color:red; font-size:15px;"><?php echo $_smarty_tpl->tpl_vars['imeprezimeprovjera']->value; ?>
                    <label>
                      <br />
                    <?php } ?>
                    <label for="username" <?php echo $_smarty_tpl->tpl_vars['usernameboja']->value; ?> id="usernamelabelregister">Username: </label>
                    ...
                    <?php if ((isset($_smarty_tpl->tpl_vars['usernameprovjera']->value)) && strlen($_smarty_tpl->tpl_vars['usernameprovjera']->value) > 2) { ?>
                      <label style="color:red; font-size:15px;"><?php echo $_smarty_tpl->tpl_vars['usernameprovjera']->value; ?>
                        <label>
                          <br />
                        <?php } ?>
                        <label for="email" <?php echo $_smarty_tpl->tpl_vars['emailboja']->value; ?> id="emaillabelregistracija">Email adresa: </label>
                        ...
                        <?php if ((isset($_smarty_tpl->tpl_vars['emailprovjera']->value)) && strlen($_smarty_tpl->tpl_vars['emailprovjera']->value) > 2) { ?>
                          <label style="color:red; font-size:15px;"><?php echo $_smarty_tpl->tpl_vars['emailprovjera']->value; ?>
                            ...
                            <br />
                            <label for="lozinka" <?php echo $_smarty_tpl->tpl_vars['lozinkaboja']->value; ?> id="lozinkalabelregistracija">Lozinka: </label>
                            ...
                            <?php if ((isset($_smarty_tpl->tpl_vars['lozinkaprovjera']->value)) && strlen($_smarty_tpl->tpl_vars['lozinkaprovjera']->value) > 2) { ?>
                              <label style="color:red; font-size:15px;"><?php echo $_smarty_tpl->tpl_vars['lozinkaprovjera']->value; ?>
                                <label>
                                  <br />
                                <?php } ?>
                                <label for="potvrdalozinke" <?php echo $_smarty_tpl->tpl_vars['potvrdiboja']->value; ?> id="potvrdalozinkelabel">Potvrdi lozinku: </label>
...
" placeholder="potvrdi lozinku" required="required" onblur="provjeraPotvrdeneLozinke()" /><br />
    ...
    if (korisnik.length > 20 || korisnik.length < 5) { return false; } for (let i=0; i < korisnik.length; i++) { if (znakovi.indexOf(korisnik.charAt(i))===-1) { return false; } } return true; } function checkUsernameByJS() { let username=document.getElementById('username').value; let valjanUsername=isKorisnikValid(username); if (!valjanUsername) { document.getElementById('usernamelabelregister').style.color="red" ; document.getElementById('username').style.color="red" ; usernamevaljan=false; poruka.innerHTML="Username ne smije sadržavati specijalne znakove i biti dulji od 20 znakova" ; }else{ document.getElementById('usernamelabelregister').style.color="black" ; document.getElementById('username').style.color="black" ; usernamevaljan=true; poruka.innerHTML="" ; } provjeraSvihParametara(); } function isEmailValid(email) { const korisnikDomena=email.split("@"); if (korisnikDomena.length !==2) { return false; } const korisnik=korisnikDomena[0]; const domena=korisnikDomena[1].split("."); if (isKorisnikValid(korisnik)===false || domena.length !==2 || domena[0].length <=0 || domena[1].length <=0 || vrstaDomeneProvjera(domena[1])===false || nazivDomeneProvjera(domena[0])===false) { return false; }else{ return true; } } function vrstaDomeneProvjera(domena) { if (domena==="com" || domena==="hr" || domena==="info" ) { return true; } else { return false; } } function nazivDomeneProvjera(domena) { const znakovi="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ" ; if (domena.length> 20) {
      return false;
      } else {
      for (let i = 0; i < domena.length; i++) { if (znakovi.indexOf(domena.charAt(i))===-1) { return false; } } return true; } } function checkLozinke(){ let lozinka=document.getElementById('lozinka').value; console.log(lozinka); if (lozinka.length <=5 || lozinka.length>= 30) {
        ...
        let imabroj = false;
        for (var i = 0; i < lozinka.length; i++) { if (!isNaN(parseInt(lozinka[i]))) { imabroj=true; break; } } if(!imabroj){ document.getElementById('lozinkalabelregistracija').style.color="red" ; document.getElementById('lozinka').style.color="red" ; poruka.innerHTML="Lozinka mora sadržavati barem 1 broj" ; lozinkavaljana=false; }else{ document.getElementById('lozinkalabelregistracija').style.color="black" ; document.getElementById('lozinka').style.color="black" ; poruka.innerHTML="" ; lozinkavaljana=true; } } } function provjeraPotvrdeneLozinke(){ let lozinka=document.getElementById('lozinka').value; let potvrdalozinke=document.getElementById('potvrdalozinke').value; if(lozinka===potvrdalozinke){ potvrdalozinkevaljana=true; document.getElementById('potvrdalozinke').style.color="black" ; document.getElementById('potvrdalozinkelabel').style.color="black" ; }else{ potvrdalozinkevaljana=false; document.getElementById('potvrdalozinke').style.color="red" ; document.getElementById('potvrdalozinkelabel').style.color="red" ; } provjeraSvihParametara(); } function provjeraSvihParametara(){ let response=grecaptcha.getResponse(); if(response.length>0){
          captchavaljana = true;
          }else{
