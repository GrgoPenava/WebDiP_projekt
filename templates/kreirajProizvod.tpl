        ...
        <form id="kreirajKampanju" method="post" name="urediProizvod" action="" novalidate enctype="multipart/form-data">
          <fieldset>
            ...
            {foreach $sviStatusi as $status}
                <option value="{$status['id_status_proizvoda']}" onchange="provjera()">{$status['naziv']}</option>
            {/foreach}
            </select>
            <br/>
            ...
            {foreach $sviTipoviProizvoda as $tip}
                <option value="{$tip['ID_tip_proizvoda']}" onchange="provjera()" >{$tip['naziv']}</option>
            {/foreach}
            </select>
            <br/>
            ...
            {foreach $sviKorisnici as $korisnik}
                <option value="{$korisnik['ID_korisnik']}" onchange="provjera()">{$korisnik['username']}</option>
            {/foreach}
            </select>
            <br/>
